...
class DigitalAssetsList extends StatefulWidget {
  DigitalAssetsList({
    Key key,
  }) : super(key: key);

  @override
  _DigitalAssetsListState createState() => _DigitalAssetsListState();
}

class _DigitalAssetsListState extends State<DigitalAssetsList> {
